...
|查阅已停止的 Draft→Public 分支|[[历史归档/历史分支_Draft-to-Public_目前不可用_2026-07-21/README|Draft-to-Public 历史分支]]|历史分支，目前不可用；不得作为当前正文生成输入|
...
原作者审美链、表达重构方法库、盲写 Public 模板、二次改写 Skill 和 Public 回灌 Draft 规则已整体归档：

- [[历史归档/历史分支_Draft-to-Public_目前不可用_2026-07-21/README|Draft-to-Public 历史分支（目前不可用）]]。

当前不再执行 Draft→Public，也不再把该分支的去 AI 化规则自动回灌 Draft。正文工作回到 Draft 的源头生成问题。
